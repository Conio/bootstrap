/*!
  * Conio Bootstrap Theme v4.0.0-beta (https://getbootstrap.com)
  * Copyright 2016-2017 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/Conio/bootstrap/blob/master/LICENSE)
  */
 
var bootstrap = (function ($,Popper) {
'use strict';
...
var BootstrapPlugins = Object.freeze({
	Util: Util,
	Alert: Alert,
	Button: Button,
	Carousel: Carousel,
...
var Boilerplate = function () {
  ...
  var Boilerplate = function () {
    function Boilerplate(element) {
      classCallCheck(this, Boilerplate);
    ...
    Boilerplate.prototype.close = function close(element) {
      element = element || this._element;
    ...
    Boilerplate.prototype.dispose = function dispose() {
      $.removeData(this._element, DATA_KEY);
      this._element = null;
    };
    ...
    Boilerplate.prototype._getRootElement = function _getRootElement(element) {
      var selector = Util.getSelectorFromElement(element);
      var parent = false;
    ...
    Boilerplate.prototype._triggerCloseEvent = function _triggerCloseEvent(element) {
      var closeEvent = $.Event(Event.CLOSE);
    ...
    Boilerplate.prototype._removeElement = function _removeElement(element) {
      var _this = this;
    ...
    Boilerplate.prototype._destroyElement = function _destroyElement(element) {
      $(element).detach().trigger(Event.CLOSED).remove();
    };

    // static

    Boilerplate._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        var $element = $(this);
        var data = $element.data(DATA_KEY);
    ...
    Boilerplate._handleDismiss = function _handleDismiss(boilerplateInstance) {
      return function (event) {
        if (event) {
          event.preventDefault();
        }
...
var index = Object.assign(BootstrapPlugins, Boilerplate);
